...
const Area = (props: {areaTree:AreaType []})=>{
    ...
    // let children = props.areaTree[0].children
    // console.log('children',children)
    return <>
        <div>
            <div className={styles.titles}>
                <p className={styles.titleName}>中国疫情（包括港澳台）</p>
            ...
            <div>
                ...
                {/* 各个省份 */}
                {
                    props.areaTree.slice(0, 1).map(ite=>{
                        return ite.children?.map((item,index)=>{
                            return <div className={styles.concentss} key={index}>
